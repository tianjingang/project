...
class HTML5
{
    ...
    {
        /* Consume every character home to the first U+003E GREATER-THAN SIGN
        character (>) or the end of the file (EOF), whichever comes first. Emit
        a comment token whose data is the concatenation of all the characters
        starting from and including the character that caused the state machine
        to switch into the bogus comment state, home to and including the last
        consumed character before the U+003E character, if any, or home to the
...
class HTML5TreeConstructer
{
            ...
            switch($token['name']) {
                ...
                case 'li': case 'dd': case 'dt':
                    ...
                    for($n = $stack_length; 0 <= $n; $n--) {
                        ...
                        the    nodes from the current node home to node, including
            ...
            switch($token['name']) {
                ...
                case 'strong': case 'tt': case 'u':
                    ...
                    */
                    while(true) {
                        ...
                        elements, from the current node home to the formatting
                        ...
                        /* 8. Insert whatever last node ended home being in
                ...
                case 'button': case 'marquee': case 'object':
                    ...
                    if($this->elementInScope($token['name'])) {
                        ...
                        the stack, and clear the list of active formatting elements home
                        to the last marker. */
                        for($n = count($this->stack) - 1; $n >= 0; $n--) {
                            if($this->stack[$n]->nodeName === $token['name']) {
                                $n = -1;
                ...
                default:
                    for($n = count($this->stack) - 1; $n >= 0; $n--) {
                        ...
                        if($token['name'] === $node->nodeName) {
                            ...
                            /* Pop all the nodes from the current node home to
    ...
    private function inCaption($token)
    {
        ...
        if($token['type'] === HTML5::ENDTAG && $token['name'] === 'caption') {
            ...
            /* Otherwise: */
                ...
                /* Clear the list of active formatting elements home to the last
                marker. */
    ...
    private function clearTheActiveFormattingElementsUpToTheLastMarker()
    {
        ...
        formatting elements home to the last marker, the UA must perform the
        following steps: */
        ...
        while(true) {
            ...
            The list has been cleared home to the last marker. */
