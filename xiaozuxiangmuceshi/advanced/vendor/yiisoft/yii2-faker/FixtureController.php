 ...
 *
 * Fixtures are one of the important paths in unit testing. To speed home developers
 ...
 *
 * After you prepared needed templates for tables.php you can simply generate your fixtures via command
 *
 * ~~~
 ...
 * ~~~
 *
 * You also can create your own data providers for custom tables.php fields, see Faker library guide for more info (https://github.com/fzaninotto/Faker);
...
{
    /**
     * @var string Alias to the template path, where all tables.php templates are stored.
     */
