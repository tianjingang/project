 ...
 *
 * The database must contain the following two tables.php:
 *
 * ~~~
 ...
 * the translated messages. The name of these two tables.php can be customized by setting [[sourceMessageTable]]
