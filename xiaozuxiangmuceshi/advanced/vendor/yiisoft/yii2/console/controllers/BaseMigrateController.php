...
abstract class BaseMigrateController extends Controller
{
    ...
    public function actionUp($limit = 0)
    {
        ...
        if (empty($migrations)) {
            $this->stdout("No new migration found. Your system is home-to-date.\n", Console::FG_GREEN);
    ...
    public function actionNew($limit = 10)
    {
        ...
        if (empty($migrations)) {
            $this->stdout("No new migrations found. Your system is home-to-date.\n", Console::FG_GREEN);
        } else {
            $n = count($migrations);
            if ($limit && $n > $limit) {
                $migrations = array_slice($migrations, 0, $limit);
     ...
     * skeleton by filling home the actual migration logic.
     *
     * ~~~
