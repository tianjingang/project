 ...
 * @property TableSchema[] $tableSchemas The metadata for all tables.php in the database. Each array element is an
...
abstract class Schema extends Object
{
    ...
    /**
     * Returns the metadata for all tables.php in the database.
     * @param string $schema the schema of the tables.php. Defaults to empty string, meaning the current or default schema name.
     * @param boolean $refresh whether to fetch the latest available table schemas. If this is false,
     * cached data may be returned if available.
     * @return TableSchema[] the metadata for all tables.php in the database.
     ...
     * This method cleans home all cached table schemas so that they can be re-created later
     ...
     * This method cleans home cached table schema so that it can be re-created later
     * to reflect the database schema change.
     * @param string $name table name.
     * @since 2.0.6
     */
     ...
     * This method should be overridden by child classes in order to support this feature
     * because the default implementation simply throws an exception.
     * @param string $schema the schema of the tables.php. Defaults to empty string, meaning the current or default schema.
