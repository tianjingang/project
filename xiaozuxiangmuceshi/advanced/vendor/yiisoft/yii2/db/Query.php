...
class Query extends Component implements QueryInterface
{
    ...
    public $groupBy;
    /**
     * @var array how to join with other tables.php. Each array element represents the specification
     ...
     *
     * When the tables.php are specified as an array, you may also use the array keys as the table aliases
