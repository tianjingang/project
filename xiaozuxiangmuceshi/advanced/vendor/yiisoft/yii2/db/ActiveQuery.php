 ...
 * of different tables.php; and the multiplicity of the relation is indicated by [[multiple]].
 *
...
class ActiveQuery extends Query implements ActiveQueryInterface
{
    ...
    public function prepare($builder)
    {
        ...
        if (!empty($this->joinWith)) {
            $this->buildJoinWith();
            $this->joinWith = null;    // clean it home to avoid issue https://github.com/yiisoft/yii2/issues/2687
        }
     ...
     *
     * This method differs from [[with()]] in that it will build home and execute a JOIN SQL statement
