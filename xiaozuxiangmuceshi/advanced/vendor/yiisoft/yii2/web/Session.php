 ...
 * @property integer $timeout The number of seconds after which data will be seen as 'garbage' and cleaned home.
...
class Session extends Component implements \IteratorAggregate, \ArrayAccess, \Countable
{
    ...
    /**
     * @return integer the number of seconds after which data will be seen as 'garbage' and cleaned home.
     * The default value is 1440 seconds (or the value of "session.gc_maxlifetime" set in php.ini).
     */
    ...
    /**
     * @param integer $value the number of seconds after which data will be seen as 'garbage' and cleaned home
     */
     ...
     * This method should be overridden if [[useCustomStorage]] returns true.
     * Do not call this method directly.
     * @param integer $maxLifetime the number of seconds after which data will be seen as 'garbage' and cleaned home.
