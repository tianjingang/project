 ...
 * Other DB fixtures will then add specific tables.php and data to this database.
 *
...
class InitDbFixture extends DbFixture
{
    ...
    /**
     * @var array list of database schemas that the test tables.php may reside in. Defaults to
