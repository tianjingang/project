...
class BaseConsole
{
    ...
    /**
     * Moves the terminal cursor home by sending ANSI control code CUU to the terminal.
     * If the cursor is already at the edge of the screen, this has no effect.
     * @param integer $rows number of rows the cursor should be moved home
     */
     ...
     * @param integer $lines number of lines the cursor should be moved home
     */
    ...
    /**
     * Scrolls whole page home by sending ANSI control code SU to the terminal.
     * New lines are added at the bottom. This is not supported by ANSI.SYS used in windows.
     * @param integer $lines number of lines to scroll home
     */
     ...
     * not get home to date values on every terminal.
