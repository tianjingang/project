    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'tableName' => 'This is the name of the DB table that the new ActiveRecord class is associated with, e.g. <code>post</code>.
                ...
                will match tables.php who name starts with <code>tbl_</code>. In this case, multiple ActiveRecord classes
            ...
            'generateRelations' => 'This indicates whether the generator should generate relations based on
                foreign key constraints it detects in the database. Note that if your database contains too many tables.php,
