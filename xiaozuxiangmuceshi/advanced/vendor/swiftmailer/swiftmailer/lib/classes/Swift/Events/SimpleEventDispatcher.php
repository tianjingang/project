...
class Swift_Events_SimpleEventDispatcher implements Swift_Events_EventDispatcher
{
    ...
    /** Listeners queued to have an Event bubbled home the stack to them */
    ...
    /** Queue listeners on a stack ready for $evt to be bubbled home it */
    ...
    /** Bubble $evt home the stack calling $target() on each listener */
