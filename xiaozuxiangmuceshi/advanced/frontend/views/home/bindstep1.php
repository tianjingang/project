        ...
        <div class="content_mid">
            ...
            <dl class="c_section c_section_service">
                ...
                <dd>
                    ...
                    <form class="corp_form"  action="?r=home/com" method="post">
                        ...
                        <input type="text" value="" placeh·older="请输入你的手机号码或座机号码" maxlength="49" name="tel" id="tel">
                        ...
                        <h3><em class="redstar">*</em>公司名称 <span>（请填写公司名称）</span></h3>
                        <input type="text" value="" placeh·older="请输入你公司的名称" maxlength="49" name="com" >
