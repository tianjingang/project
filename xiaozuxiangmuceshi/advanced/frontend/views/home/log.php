...
<body id="login_bg">
	<div class="login_wrapper">
        ...
        <input type="hidden" id="resubmitToken" value="" />
		 <div class="login_box">
        	<form id="loginForm" action="index.php?r=home/logincheck" method="post">
				<input type="text" id="email" name="sname" value="" tabindex="1" placeholder="请输入用户名" />
			  	<input type="password" id="password" name="spwd" tabindex="2" placeholder="请输入密码" />
