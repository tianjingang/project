        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <dd>
                    ...
                    <form action="index.php?r=create/cre" method="post" id="jobForm">
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" value="请选择职位类别" id="select_category" class="selectr selectr_380" >
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>工作城市</td>
                                <td>
                                    <input type="text" placeholder="请输入工作城市，如：北京"  name="work" id="workAddress">
                                </td>
                            </tr>
                            </tbody></table>
