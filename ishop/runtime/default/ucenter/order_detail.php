				...
				<tbody>
					...
					<tr>
						<td>   <script type="text/javascript">
                            ...
                            <script type="text/javascript" src="http://qzonestyle.gtimg.cn/qzone/app/qzshare/script/qzshare.plus.pick.js" async="true" charset="utf-8"></script><a href="http://connect.qq.com/intro/share
"><img class="pro_pic" src="<?php echo IUrl::creatUrl("")."".$good['img']."";?>" width="50px" height="50px" onerror='this.src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/front/nopic_100_100.gif";?>"' /></a></td>
						<td class="t_l">
   ...
   <!-- <a href="http://connect.qq.com/intro/share
">分享</a>-->
   <!-- <a href="http://connect.qq.com/intro/share
">分享</a>-->
	<div class="gray_box">
