...
<style type="text/css">
    #l-map{height:100px;width:100px;}
    #r-result{width:100%;}
</style>
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=OPY7cv0xnH7fOmxZ1GUWAQvBWp0Luky0"></script>
        ...
        <div class="box clearfix">
            <form action='<?php echo IUrl::creatUrl("/simple/reg_act");?>' method='post'>
                ...
                <table class="form_table f_l">
                    <col width="260px" />
                    <col />
                    <tr><th>邀请人:</th><td><?php echo isset($this->userinfo)?$this->userinfo:"";?><input type="hidden" name="reg_id" value="<?php echo isset($this->userid)?$this->userid:"";?>"/></td></tr>
                    ...
                    <tr><th>百度地图</th><td><div id="r-result"><input type="text" id="suggestId" size="20" value="百度" style="width:150px;" /></div></td></tr>
                    <tr><th></th><td><div id="l-map"></div><div id="searchResultPanel" style="border:1px solid #C0C0C0;width:150px;height:auto; display:none;"></div>
                    </td></tr>
