...
<div class="container">
	...
	seo::set($seo_data);
?>
<meta property="qc:admins" content="17523270736154515216375" />
...
<div class="wrapper clearfix">
	...
	<div class="main f_l">
		...
		<ul class="bxslider">
			...
			<li title="<?php echo isset($item['city'])?$item['city']:"";?>"><a href="<?php echo IUrl::creatUrl("".$item['url']."");?>" target="_blank"><img src="<?php echo IUrl::creatUrl("")."".$item['img']."";?>" width="750px" title="<?php echo isset($item['name'])?$item['name']:"";?>" /></a></li>
			<?php }?>
		</ul>
		<?php }?>
	</div>
