...
<body>
    ...
    <ul>
        ...
        <li><a class="active" href="/php3xiangmu/index.php/Home/Index/contact"><div class="cnt"><i class="contact"></i><i class="contact1"></i></div></a></li>
			...
			<!--<div class="menu">
				<ul>
					<li><a class="active" href="/php3xiangmu/index.php/Home/Index/Index"><i class="home"></i></a></li>
					<li><a href="/php3xiangmu/index.php/Home/Index/videos"><div class="video"><i class="videos"></i><i class="videos1"></i></div></a></li>
					<li><a href="/php3xiangmu/index.php/Home/Index/single"><div class="cat"><i class="watching"></i><i class="watching1"></i></div></a></li>
					<li><a href="/php3xiangmu/index.php/Home/Index/hehe"><div class="bk"><i class="booking"></i><i class="booking1"></i></div></a></li>
		...
		<div class="more-reviews">
			 <ul id="flexiselDemo2">
			<li><img src="/php3xiangmu/Public/Home/images/m1.jpg" alt=""/></li>
			<li><img src="/php3xiangmu/Public/Home/images/m2.jpg" alt=""/></li>
			<li><img src="/php3xiangmu/Public/Home/images/m3.jpg" alt=""/></li>
			<li><img src="/php3xiangmu/Public/Home/images/m4.jpg" alt=""/></li>
		</ul>
			<script type="text/javascript">
		$(window).load(function() {
