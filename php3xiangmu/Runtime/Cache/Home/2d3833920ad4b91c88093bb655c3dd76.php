	...
	<div class="full">
			<div class="menu">
				<ul>
					...
					<li><a class="/php3xiangmu/index.php/Home/Index/active" href="hehe.html"><div class="bk"><i class="booking"></i><i class="booking1"></i></div></a></li>
		...
		<div class="error-content">
			...
			<div class="error-404 text-center">
                <video src="/php3xiangmu/<?php echo ($v["w_wmv"]); ?>" controls></video>
