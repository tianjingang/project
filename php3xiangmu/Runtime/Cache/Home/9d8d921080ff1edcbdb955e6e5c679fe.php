	...
	<div class="full">
			<div class="menu">
				<ul>
					...
					<li><a class="active" href="/php3xiangmu/index.php/Home/Index/reviews"><div class="cat"><i class="watching"></i><i class="watching1"></i></div></a></li>
					<li><a href="/php3xiangmu/index.php/Home/Index/hehe"><div class="bk"><i class="booking"></i><i class="booking1"></i></div></a></li>
					<li><a href="/php3xiangmu/index.php/Home/Index/contact"><div class="cnt"><i class="contact"></i><i class="contact1"></i></div></a></li>
				</ul>
			</div>
		<div class="main">
			...
			<div class="reviews-section">
				<h3 class="head">热播</h3>
					<div class="col-md-9 reviews-grids">
                        <form action="/php3xiangmu/index.php/Home/Index/ping_add" method="post">
						<div class="review">
							<div class="movie-pic">
								<a href="single.html">
                                    <video src="/php3xiangmu<?php echo ($arr["w_wmv"]); ?>" width="240"></video>
                                </a>
							</div>
							<div class="review-info">
								<a class="span" href="single.html">电影名称：<?php echo ($arr["w_name"]); ?></a>
								<p class="dirctr"><a href="">电影时长:<?php echo ($arr["w_time"]); ?></a>TNN, Mar 12, 2015, 12.47PM IST</p>
								...
								<div class="yrw">
									<div class="dropdown-button">           			
										<select class="dropdown" tabindex="9" data-settings='{"wrapperClass":"flat"}' name="ping_num">
										<option value="0">电影评分</option>
								...
								<p class="info">主演人:<?php echo ($arr["w_man"]); ?></p>
								<p class="info">观看次数:<?php echo ($arr["w_count"]); ?></p>
								<p class="info">电影时长:<?php echo ($arr["w_time"]); ?></p>
								电影评价: <textarea name="ping_han" cols="20" rows="5"></textarea>
                                <input type="hidden" name="ping_name" value="<?php echo ($arr["w_name"]); ?>"/>
			...
			<div class="comments-section-grids">
				<div class="comments-section-grid">
					<div class="col-md-2 comments-section-grid-image">
						<img src="/php3xiangmu/Public/Home/images/eye-brow.jpg" class="img-responsive" alt="" />
					</div>
					<div class="col-md-10 comments-section-grid-text">
                    <?php if(is_array($arr1)): foreach($arr1 as $key=>$arr1): ?><h4><a href="#">电影名称:<?php echo ($arr1["ping_name"]); ?></a></h4>
						<label>电影评分:<?php echo ($arr1["ping_num"]); ?>   </label>
                        <p>时间:<?php echo ($arr1["ping_time"]); ?>   </p>
						<p>电影评价:<?php echo ($arr1["ping_han"]); ?>
                            <a href="javascript:void(0)" onclick="r_talk(<?php echo ($arr1[id]); ?>)">回复</a>
                            <style id="talk"></style>
                            <div id="<?php echo ($arr1["id"]); ?>">
				...
				<div class="comments-section-grid comments-section-middle-grid">
					<div class="col-md-2 comments-section-grid-image">
						<img src="/php3xiangmu/Public/Home/images/beauty.jpg" class="img-responsive" alt="" />
					</div>
					<div class="col-md-10 comments-section-grid-text">
				...
				<div class="comments-section-grid">
					<div class="col-md-2 comments-section-grid-image">
						<img src="/php3xiangmu/Public/Home/images/stylish.jpg" class="img-responsive" alt="" />
					</div>
					<div class="col-md-10 comments-section-grid-text">
						<h4><a href="#">MARWA ELGENDY</a></h4>
						<label>5/4/2014 at 22:00   </label>
...
<script>
    function r_talk(obj){
            //alert(obj);
            var id = obj;
            document.getElementById(obj).innerHTML = "<input type='text' name='r_talk'><input type='button' onclick='add(<?php echo ($arr1[id]); ?>)' value='提交'/>";
    }

    function add(id){
        //alert(id);
        var r_talk=document.getElementsByName('r_talk')[0].value;
        //alert(r_talk);
        var ajax=new XMLHttpRequest();
        ajax.open('get',"/php3xiangmu/index.php/Home/Index/hui_add/id/"+id+"/r_talk/"+r_talk);
        ajax.send();
        ajax.onreadystatechange=function(){
            //alert('readyState');
            if(ajax.readyState==4&&ajax.status==200){
                var xmp=ajax.responseText;
                alert(xmp);
            }
        }
