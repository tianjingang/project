...
<center>
    <form action="/wendaxiangmu/index.php/Admin/User/show1/" method="post">
        <table border="1">
            <tr>
                <td>ID</td>
                <td>账号</td>
            ...
            <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="/wendaxiangmu/index.php/Admin/User/open_user/id/<?php echo ($val["id"]); ?>">解锁</a>
                        <a href="/wendaxiangmu/index.php/Admin/User/del/id/<?php echo ($val["id"]); ?>">永久删除</a>
