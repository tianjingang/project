...
<script>
    $(function(){
        $('#more').click(function(){
            ...
            $.ajax({
                type: 'post',
                url: "/wendaxiangmu/index.php/Home/Index/question",
                data: {
...
<div id="nav">
	<ul class="list">
		...
		<li class="nav-sel ask-cate">
			...
			<ul class="hidden">
                <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Category/show',array('id'=>$val['id']));?>"><?php echo ($val["c_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
		</li>
	</ul>
...
<script type="text/javascript" src="/wendaxiangmu/Public/Home/js/validate.js"></script>
	...
	<div id="register" class="hidden">
		...
		<div id="reg-wrap">
			...
			<div class="reg-right">
				<form action="<?php echo U('HDUser/add');?>" method="post" name="register">
					<ul>
						<li>
						...
						<li>
                            ...
                            <input class="len250" name="code" type="code" style="width:100px;"> <img src="/wendaxiangmu/index.php/Home/Index/verify" id="code" style="width: 100px;"> <a href="javascript:void(0);" id="codes">看不清</a>
	...
	<div id="login" class="hidden">
		...
		<div class="login-form">
			...
			<form action="<?php echo U('Common/login_check');?>" method="post" name="login">
				<ul>
					<li>
            ...
            <ul class='left-list'>
                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class='list-l1'>
                        <div class='list-l1-wrap'>
                            <h4><a href="<?php echo U('Category/show',array('id'=>$val['id']));?>"><?php echo ($val["c_name"]); ?></a></h4>
                            <ul class='list-l2'>
                                <?php $__FOR_START_20169__=0;$__FOR_END_20169__=3;for($i=$__FOR_START_20169__;$i < $__FOR_END_20169__;$i+=1){ ?><li><a href="<?php echo U('Category/show',array('id'=>$val['child'][$i]['id']));?>"><?php echo ($val['child'][$i]['c_name']); ?></a></li><?php } ?>
                            </ul>
                        </div>

                        <div class='list-more hidden'>
                            <ul>
                                <?php $__FOR_START_31182__=3;$__FOR_END_31182__=count($val["child"]);for($i=$__FOR_START_31182__;$i < $__FOR_END_31182__;$i+=1){ ?><li><a href="<?php echo U('Category/show',array('id'=>$v['child'][$i]['id']));?>"><?php echo ($val['child'][$i]['c_name']); ?></a></li><?php } ?>
                            </ul>
                        </div>
        ...
        <div id="center">
			<div id="animate">
				<div class="imgs-wrap">
					<ul>
						<li>
							<a href=""><img src="/wendaxiangmu/Public/Home/images/animate1.png" height="190" width="558"></a>
						</li>
						<li style="opacity: 0;">
							<a href=""><img src="/wendaxiangmu/Public/Home/images/animate2.png" height="190" width="558"></a>
						</li>
						<li style="opacity: 0;">
							<a href=""><img src="/wendaxiangmu/Public/Home/images/animate3.png" height="190" width="558"></a>
						</li>
					</ul>
				</div>
				<ul class="ani-btn">
...
<?php $arrr=M('hd_ask')->limit(5)->where("solve=0")->select(); ?>
			<dl class="answer-list" id="cate">
				<dt>
					<span class="wait-as">待解决问题</span>
                </dt>

                <?php if(is_array($arrr)): $i = 0; $__LIST__ = $arrr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><dd>

                        <a href="javascript:void(0)"><?php echo ($val["content"]); ?></a>
                        <span>0回答</span>
					</dd><?php endforeach; endif; else: echo "" ;endif; ?>
                <input type="hidden" name="page"value="5"/>
            </dl>
            <a href="javascript:;" id="more">加载更多&gt;&gt;</a>
            <a href="<?php echo U('Index/index');?>">收起&gt;&gt;</a>
        ...
        <div id="right">
            <?php if($_SESSION['user']== null): ?><div class="r-login">
                ...
                <div class="userinfo">
                    <dl>
                        ...
                        <dt>
                            <a href="<?php echo U('User/self');?>"><img src="/wendaxiangmu/Public/Home/Images/noface.gif" height="48" width="48"></a>
                        </dt>
                        <dd class='username'>
