...
//通信相关
define('UC_KEY', 'tianjingang1');				// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://www.ishopp.com/uc_server');	// UCenter 的 URL 地址, 在调用头像时依赖此常量
...
$tablepre = 'iwebshop_';   		// 表名前缀, 同一数据库安装多个论坛请修改此处
