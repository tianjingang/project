...
<div class="wrapper clearfix">
    ...
    <div class="main f_l">
        <?php if($this->cityinfo){?>
        <ul class="bxslider">
            <?php foreach($this->cityinfo as $key => $item){?>
            <li title="<?php echo isset($item['city'])?$item['city']:"";?>"><a href="<?php echo IUrl::creatUrl("".$item['url']."");?>" target="_blank"><img src="<?php echo IUrl::creatUrl("")."".$item['img']."";?>" width="750px" height="300px" title="<?php echo isset($item['name'])?$item['name']:"";?>" /></a></li>
            <?php }?>
        </ul>
        <?php }?>
    </div>
...
<div class="main f_l">
    ...
    <?php if($this->manage_data){?>
    <ul class="bxslider">
        <?php foreach($this->manage_data as $key => $item){?>
        <li title=""><a href="<?php echo IUrl::creatUrl("".$item['url']."");?>" target="_blank"><img src="<?php echo IUrl::creatUrl("")."".$item['content']."";?>" width="750px" height="300px" title="" /></a></li>
        <?php }?>
    </ul>
    <?php }?>
</div>
...
<div class="main f_l">
    ...
    <form action="<?php echo IUrl::creatUrl("/site/adds");?>" method="post">
        <table>
            <tr>
                <td>金牌数量</td>
    ...
    <table align="center">
        <?php if($this->jingcaiinfo){?>
        <ul>
            <?php foreach($this->jingcaiinfo as $key => $item){?>
                <li><?php echo isset($item['person'])?$item['person']:"";?>
                <?php echo isset($item['sum'])?$item['sum']:"";?>积分</li>
            <?php }?>
        </ul>
        <?php }?>
    </table>
...
<div class="wrapper clearfix">
	<div class="sidebar f_r">
       ...
       <div class="box yellow m_10">
            ...
            <div class="cont clearfix">
                <ul class="prolist">
                    <?php foreach($this->datas as $key => $item){?>
	...
	<div class="main f_l">
        ...
        <table id="index_category" class="sort_table m_10" width="100%">
			...
			<col />
            <tr>
                <th><a href="<?php echo IUrl::creatUrl("/site/movie_seat");?>">最新电影</a></th>
                <td></td>
            </tr>
        </table>
        <div class="cont clearfix">
            <ul class="prolist">
                <?php foreach($this->videoinfo as $key => $item){?>
                <?php $tmpId=$item['id'];?>
                <li style="overflow:hidden">
                    <p class="pro_title" style="text-align: center; font-size: 15px;"><a title="<?php echo isset($item['video_name'])?$item['video_name']:"";?>" href="<?php echo IUrl::creatUrl("/site/movie_seat/id/".$tmpId."");?>"><font color="green"><?php echo isset($item['video_name'])?$item['video_name']:"";?></font></a></p>
                    <a href="<?php echo IUrl::creatUrl("/site/movie_seat/id/".$tmpId."");?>"> <video src="<?php echo isset($item['video'])?$item['video']:"";?>" controls="controls" height="170px" width="170px" ></video></a>
                    <a href="<?php echo IUrl::creatUrl("/site/movie_seat/id/".$tmpId."");?>"><p class="light_gray" style="text-align: center; font-size: 15px;"><font color="aqua">票价：</font><font color="aqua">￥<?php echo isset($item['price'])?$item['price']:"";?></font></p>
                </a></li>
                <?php }?>
            </ul>
        </div>
		...
		<div class="box yellow m_10">
			...
			<div class="cont clearfix">
				<ul class="prolist">
					...
					<?php $tmpId=$item['id'];?>
					<li style="overflow:hidden">
                        <p style="text-align: center;font-size: 10px;"><a href="<?php echo IUrl::creatUrl("/rowlock/minutes/id/".$tmpId."");?>"><font color="red" size="2">秒杀</font></a></p>
						<a href="<?php echo IUrl::creatUrl("/site/products/id/".$tmpId."");?>"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/175/h/175");?>" width="175" height="175" alt="<?php echo isset($item['name'])?$item['name']:"";?>" /></a>
						<p class="pro_title"><a title="<?php echo isset($item['name'])?$item['name']:"";?>" href="<?php echo IUrl::creatUrl("/site/products/id/".$tmpId."");?>"><?php echo isset($item['name'])?$item['name']:"";?></a></p>
						<p class="brown">惊喜价：<b>￥<?php echo isset($item['sell_price'])?$item['sell_price']:"";?></b></p>
						<p class="light_gray">市场价：<s>￥<?php echo isset($item['market_price'])?$item['market_price']:"";?></s></p>
