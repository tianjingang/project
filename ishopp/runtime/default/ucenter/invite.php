...
<body>
<form action='<?php echo IUrl::creatUrl("/ucenter/doinvite");?>' method='post'>
    请输入您要邀请的好友邮箱
    <input class="gray" type="text" name='email' placeholder="输入邀请人邮箱 多邮箱请用英文;分号隔开"  alt="填写正确的邮箱格式" />
    <input type="hidden" name='callback' />
    <input type="submit" value="邀请" />
    <p>邀请成功累计人数:<?php echo isset($num)?$num:"";?></p>
</form>
</body>
</html>
	</div>
