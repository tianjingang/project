...
class Seller extends IController implements sellerAuthorization
{
	...
	public function goods_list()
	{
		...
		$goodHandle->fields = "distinct go.id,go.name,go.sell_price,go.market_price,go.store_nums,go.img,go.is_del,go.seller_id,go.is_share";
	...
	public function order_list()
	{
		...
		$where = "go.seller_id='$seller_id' and o.if_del=0 and o.status not in(3,4)";
		$where .= $condition ? " and ".$condition : "";
