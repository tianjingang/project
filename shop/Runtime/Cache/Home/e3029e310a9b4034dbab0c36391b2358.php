		...
		<div class="shop_gwc_bd_contents clearfix">
			...
			<table>
                ...
                <?php if(is_array($br)): $i = 0; $__LIST__ = $br;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
						<td class="gwc_list_pic"><a href=""><img src="/shop/<?php echo ($v["goods_img"]); ?>" alt="" height="80" width="80"/><!--<img src="/shop/Public/Home/images/4_7b5239c3f153ae4b67ff760f54408a5b.jpg_tiny.jpg" />--></a></td>
						...
						<td class="gwc_list_shuliang"><span name="g_number"><a class="good_num_jian this_good_nums" did="danjia_001" xid="xiaoji_001" ty="-" valId="goods_001" href="javascript:void(0);">-</a><input type="text" value="<?php echo ($v["goods_number"]); ?>" id="goods_001" class="good_nums" /><a href="javascript:void(0);" did="danjia_001" xid="xiaoji_001" ty="+" class="good_num_jia this_good_nums"  name="jia" id="<?php echo ($v["g_id"]); ?>" valId="goods_001">+</a></span></td>
					...
					<tr>
						<td colspan="6">
							...
							<div class="gwc_foot_links">
								<a href="<?php echo U('Index/index');?>" class="go">继续购物</a>
								<a href="<?php echo U('Flow/flow2');?>" class="op">去购物车结算</a>
							</div>
						</td>
					</tr>
				</tfoot>
...
<script>
    ...
    $(function(){
        $('a[name="del"]').click(function(){
            ...
            $.ajax({
                type:'post',
                url :'/shop/index.php/Home/Flow/del',
                data:{
                  g_id:g_id
                },
  ...
  //价格变动
    $(function(){
        /*  $('a[name="jia"]').click(function(){
            //alert('jia');
      var g_id=$('this').attr('id'\\;
            var goods_number=$('span[name="g_number"]').val();
            $.ajax({
                type:'post',
                url:'/shop/index.php/Home/Flow/price',
                data:{
                    g_id:g_id,
