...
<head>
	...
	<link rel="stylesheet" href="/shop/Public/Home/css/shop_list.css" type="text/css" />
    <link rel="stylesheet" href="/shop/Public/Home/css/shop_goods.css" type="text/css" />
    ...
    <script type="text/javascript" src="/shop/Public/Home/js/shop_goods.js" ></script>
</head>
<body>
	...
	<div class="shop_goods_bd clear">
		...
		<div class="shop_goods_show">
			<div class="shop_goods_show_left">
				<!-- 京东商品展示 -->
				<link rel="stylesheet" href="/shop/Public/Home/css/shop_goodPic.css" type="text/css" />
				<script type="text/javascript" src="/shop/Public/Home/js/shop_goodPic_base.js"></script>
				<script type="text/javascript" src="/shop/Public/Home/js/lib.js"></script>
				<script type="text/javascript" src="/shop/Public/Home/js/163css.js"></script>
				<div id="preview">

					<div class=jqzoom id="spec-n1" onClick="window.open('/')">
                        <?php if(is_array($ara)): $i = 0; $__LIST__ = $ara;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><IMG height="350" src="/shop/<?php echo ($val["goods_img"]); ?>" jqimg="/shop/<?php echo ($val["goods_img"]); ?>" width="350"><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
						<div id="spec-n5">
							<div class=control id="spec-left">
								<img src="/shop/Public/Home/images/left.gif" />
							</div>
							<div id="spec-list">
								<ul class="list-h">
                                    <!--<?php if(is_array($ar)): $i = 0; $__LIST__ = $ar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><img src="/shop/<?php echo ($val["goods_img"]); ?>" alt="" width="80" height="80"/></li><?php endforeach; endif; else: echo "" ;endif; ?>-->
									<li><img src="/shop/Public/Home/images/img01.jpg"> </li>
									<li><img src="/shop/Public/Home/images/img02.jpg"> </li>
									<li><img src="/shop/Public/Home/images/img03.jpg"> </li>
									<li><img src="/shop/<?php echo ($val["goods_img"]); ?>"> </li>
									<li><img src="/shop/Public/Home/images/img01.jpg"> </li>
									<li><img src="/shop/Public/Home/images/img02.jpg"> </li>
									<li><img src="/shop/Public/Home/images/img03.jpg"> </li>
									<li><img src="/shop/<?php echo ($val["goods_img"]); ?>"> </li>
							...
							<div class=control id="spec-right">
								<img src="/shop/Public/Home/images/right.gif" />
							</div>
			...
			<div class="shop_goods_show_right">
                <?php echo ($vl["g_id"]); ?>
                <form action="<?php echo U('Shop/login_session');?>" method="post">

				<ul>
                    <li>
                        <?php if(is_array($ara)): $i = 0; $__LIST__ = $ara;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i;?><input type="hidden" value="<?php echo ($vl['g_id']); ?>" name="g_id"/>
						<strong style="font-size:14px; font-weight:bold;"><?php echo ($vl["keywords"]); ?></strong><?php endforeach; endif; else: echo "" ;endif; ?>
					</li>
					<li>
						<label>价格：</label>
						<span><strong><?php echo ($vl["shop_price"]); ?></strong>元</span>
					</li>
					<li>
						<label>运费：</label>
						<span>卖家承担运费</span>
					...
					<li class="goods_num">
						<label>购买数量：</label>
						<span><a class="good_num_jian" id="good_num_jian" href="javascript:void(0);"></a><input type="text" value="1"  name="good_sums" id="good_nums" class="good_nums" /><a href="javascript:void(0);" id="good_num_jia" class="good_num_jia"></a>(当前库存<?php echo ($vl["goods_number"]); ?>件)</span>
					</li>
					<li style="padding:20px 0;">
						<label>&nbsp;</label>
<!--
						<span><a href="<?php echo U('Shop/login_session',array('id'=>$vl['g_id']));?>" class="goods_sub goods_sub_gou">加入购物车</a></span>
-->
				...
				<div class="contents clearfix">
					<ul class="clearfix">
						...
						<li class="clearfix">
							...
							<div class="goods_pic"><span class="goods_price">¥ 279.00 </span><a href=""><img src="/shop/Public/Home/images/89a6d6466b00ae32d3c826b9ec639084.jpg_small.jpg" /></a></div>
		...
		<!-- 商品详情 -->
		<script type="text/javascript" src="/shop/Public/Home/js/shop_goods_tab.js"></script>
...
<script>
    ...
    $(function(){
        //获取节点
       $('a[name="jia"]').click(function(){
           var good_sums=$(this).val();
           $.ajax({
               type:get;
               url:Apps/Home/Shop/login_session;
               data:{
                   good_sums:good_sums
               },
