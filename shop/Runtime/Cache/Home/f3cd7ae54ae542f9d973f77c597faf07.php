...
<head>
	...
	<link rel="stylesheet" href="/shop/Public/Home/css/shop_form.css" type="text/css" />
		...
		<div class="shop_member_bd_right clearfix">
            <div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form">
					<form action="<?php echo U('Address/address_add');?>" class="shop_form" method="post">
						<ul>
							<li><label><span>*</span>收货人姓名：</label><input type="text" class="form-text" name="a_name"/></li>
							<li><label><span>*</span>所在地：</label><input type="text" class="form-text" name="a_local"/></li>
							<li><label>详细地址：</label>
                               <!-- <input type="text" class="form-text" name="a_address"/>-->
                                <textarea name="a_address" id="" cols="30" rows="1"></textarea>
                            </li>
							<li><label>邮编：</label><input type="text" class="form-text" name="a_edit" /></li>
							<li><label>电话：</label><input type="text" class="form-text" name="a_tele"/></li>
							<li><label>手机号：</label><input type="text" class="form-text" name="a_phone"/></li>
