	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="/shop/Public/Admin/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
			</span>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo U('Good/good_list');?>" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="<?php echo U('Good/good');?>" target="main-frame">添加新商品</a></li>
