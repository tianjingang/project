...
<div class="form-div">
    <form action="" name="searchForm">
        ...
        <select name="c_id" onchange="hideCatDiv()">
            ...
            <?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["c_id"]); ?>"><?php echo ($val["html"]); echo ($val["c_type"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <!-- 品牌 -->
        <select name="b_id">
...
<form method="post" action="" name="listForm" onsubmit="return confirmSubmit(this)">
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($resource)): $i = 0; $__LIST__ = $resource;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center">
                        <a href="/shop/index.php/Admin/Good/hui/id/<?php echo ($val["g_id"]); ?>/" target="_blank" title="恢复"><img src="/shop/Public/Admin/images/icon_view.gif" width="16" height="16" border="0"></a>
                        <a href="/shop/index.php/Admin/Good/del/id/<?php echo ($val["g_id"]); ?>/" title="永久删除"><img src="/shop/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0"></a>
                    </td>
