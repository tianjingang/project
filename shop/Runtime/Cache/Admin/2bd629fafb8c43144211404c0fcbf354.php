...
<!--
var pic = new Image();
pic.src="/shop/Public/Admin/images/arrow_right.gif";
...
function toggleMenu()
{
  ...
  {
    frmBody.cols="200, 10, *";
    imgArrow.src = "/shop/Public/Admin/images/arrow_left.gif";
  }
  else
  {
    frmBody.cols="0, 10, *";
    imgArrow.src = "/shop/Public/Admin/images/arrow_right.gif";
  }
}
...
<table height="100%" cellspacing="0" cellpadding="0" id="tbl">
  <tr><td><a href="javascript:toggleMenu();"><img src="/shop/Public/Admin/images/arrow_left.gif" width="10" height="30" id="img" border="0" /></a></td></tr>
</table>
</body>
</html>